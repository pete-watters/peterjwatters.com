...
function() {
	...
	var portfolioCollection = new PortfolioCollection([
			...
			new PortfolioModel({ title : 'Comhairle Teicneolaiochta' , description_short : 'comhairleteicneolaiochta.ie', image : 'app/img/portfolio/comhairleteic.jpg', modal_id : 'modal-04' , modal_href_title :'Comhairle Teicneolaiochta' , description_long : 'I created this website for my UX consultancy company, Comhairle Teicneolaiochta', tags : 'Branding, Webdesign', demo_link : 'http://comhairleteicneolaiochta.ie/'}),
			new PortfolioModel({ title : 'Coming soon page' , description_short : 'Coming soon', image : 'app/img/portfolio/comingsoon.jpg', modal_id : 'modal-05' , modal_href_title :'Coming soon' , description_long : 'A fancy placeholder page for under construction sites', tags : 'Branding, Webdesign', demo_link : '#'}),
			new PortfolioModel({ title : 'Easy Docs' , description_short : 'EasyDocs', image : 'app/img/portfolio/easydocs.jpg', modal_id : 'modal-06' , modal_href_title :'Easy docs' , description_long : 'I worked with EasyDocs in the early stages of their product to help them to migrate from a java based application to a javascript one. I helped them migrate to a much faster system using Backbone and Bootstrap in the front end. ', tags : 'Backbone, JS, Bootstrap, CSS, Branding, Webdesign', demo_link : 'http://peterjwatters.com/portfolio/easyDocs/'}),
			new PortfolioModel({ title : 'Integra' , description_short : 'integra.ie', image : 'app/img/portfolio/integra.jpg', modal_id : 'modal-07' , modal_href_title :'Integra' , description_long : 'I designed and created this site in 24 hour session back when I was working with Ocuco in 2009. It was intended to provide information and help to sell the main pharmacy POS product.', tags : 'PHP, HTML, CSS, Branding, Webdesign', demo_link : 'http://peterjwatters.com/portfolio/integra/'}),
			...
			new PortfolioModel({ title : 'Irene Henriksen Photography' , description_short : 'Irene Henriksen Photography', image : 'app/img/portfolio/irenehenriksenphotography.jpg', modal_id : 'modal-08' , modal_href_title :'Irene Henriksen Photography' , description_long : 'I created this site for a photographer. The site uses Backbone-Marrionnette for its structure and loads in a JSON feed from Flickr with her photography', tags : 'Photography, Backbone, Branding, Webdesign', demo_link : 'http://www.irenehenriksenphotography.com'}),
			...
			new PortfolioModel({ title : 'Peters Photos' , description_short : 'Peters Photos', image : 'app/img/portfolio/petersphotos.jpg', modal_id : 'modal-12' , modal_href_title :'Coffee Title' , description_long : 'This is a website I created for sharing pictures', tags : 'Branding, Webdesign', demo_link : '#'}),
			new PortfolioModel({ title : 'TNF Support Dashboard' , description_short : 'TNF Support Dashboard', image : 'app/img/portfolio/TNF_supportdashboard.jpg', modal_id : 'modal-15' , modal_href_title :'TNF Support Dashboard' , description_long : 'An interactive dashboard for monitoring server performance in real time', tags : 'Branding, Web design, UNIX, Nagios,', demo_link : '#'})
		]);
