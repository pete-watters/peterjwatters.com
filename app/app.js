...
function() {
	...
	var portfolioCollection = new PortfolioCollection([
			...
			new PortfolioModel({ title : 'Peters Photos' , description_short : 'Peters Photos', image : 'app/img/portfolio/petersphotos.jpg', modal_id : 'modal-12' , modal_href_title :'Coffee Title' , description_long : 'This is a website I create for sharing pictures', tags : 'Branding, Webdesign', demo_link : '#'}),
